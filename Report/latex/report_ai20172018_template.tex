...
\usepackage{amsmath,graphicx,ai4}

\toappear{ARTIFICIAL INTELLIGENCE (H) 2017/2018 - ASSESED EXERCISE}
...
% Single address.
% ---------------
\name{Author(s) Name(s) and Student ID(s)}
\address{Team number and Author Affiliation(s)}
